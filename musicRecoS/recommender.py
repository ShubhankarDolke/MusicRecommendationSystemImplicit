...
from musicRecoS.data import load_user_artists, ArtistRetriever
...
if __name__ == "__main__":
    ...
    # user_artists = load_user_artists(Path("C:\Users\dolke\PycharmProjects\MusicRecommendationSystem\LastFMData\user_artists.dat"))
    user_artists = load_user_artists(
        Path("C:/Users/dolke/PycharmProjects/MusicRecommendationSystem/LastFMData/user_artists.dat"))

    # instantiate artist retriever
    artist_retriever = ArtistRetriever()
    artist_retriever.load_artists(
        Path("C:/Users/dolke/PycharmProjects/MusicRecommendationSystem/LastFMData/artists.dat"))
    ...
    artists, scores = recommender.recommend(5, user_artists, n=5)
