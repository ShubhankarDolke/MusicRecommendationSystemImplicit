...
def load_user_artists(user_artists_file: Path) -> scipy.sparse.csr_matrix:
    ...
    :rtype: object
    """
    user_artists = pd.read_csv("C:/Users/dolke/PycharmProjects/MusicRecommendationSystem/LastFMData/user_artists.dat",
                               sep="\t")
...
class ArtistRetriever:
    ...
    def load_artists(self, artists_file: Path) -> None:
        ...
        artists_df = pd.read_csv(
            Path("C:/Users/dolke/PycharmProjects/MusicRecommendationSystem/LastFMData/artists.dat"), sep="\t")
